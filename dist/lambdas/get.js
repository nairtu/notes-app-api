...
exports.handler = function (event, context, callback) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!(!_.isNull(pathParams) && _.has(pathParams, "id"))) {
            ...
            try {
                yield dynamo_db_service_1.dynamoDB.get(getQuery, (error, data) => {
                    if (error) {
                        callback(error, response_service_1.failure(getQuery));
                    }
                    else {
                        callback(null, response_service_1.success(data.Item));
                    }
                }).promise();
            }
            catch (e) {
                callback(e, response_service_1.failure(getQuery));
            }
        }
    });
};
